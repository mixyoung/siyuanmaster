...
export const READ_ONLY_TOOLS = ["get_policy","list_accessible_notebooks","list_document_tree","search_notes","read_note","resolve_document","read_note_segments","suggest_tags","prepare_summary","get_audit_log"] as const;
...
export const CATALOG_TOOLS: CatalogTool[] = [{"name":"get_policy","category":"policy","readOnly":true,"confirmDefault":false},{"name":"list_accessible_notebooks","category":"notebook","readOnly":true,"confirmDefault":false},{"name":"list_document_tree","category":"tree","readOnly":true,"confirmDefault":false},{"name":"search_notes","category":"search","readOnly":true,"confirmDefault":false},{"name":"read_note","category":"read","readOnly":true,"confirmDefault":false},{"name":"resolve_document","category":"read","readOnly":true,"confirmDefault":false},{"name":"read_note_segments","category":"read","readOnly":true,"confirmDefault":false},{"name":"create_note","category":"write","readOnly":false,"confirmDefault":false},{"name":"append_note","category":"write","readOnly":false,"confirmDefault":false},{"name":"update_note","category":"write","readOnly":false,"confirmDefault":true},{"name":"edit_block","category":"block","readOnly":false,"confirmDefault":true},{"name":"rename_note","category":"structure","readOnly":false,"confirmDefault":true},{"name":"move_note","category":"structure","readOnly":false,"confirmDefault":true},{"name":"delete_note","category":"write","readOnly":false,"confirmDefault":true},{"name":"suggest_tags","category":"tag","readOnly":true,"confirmDefault":false},{"name":"apply_tags","category":"tag","readOnly":false,"confirmDefault":false},{"name":"prepare_summary","category":"read","readOnly":true,"confirmDefault":false},{"name":"save_memory","category":"write","readOnly":false,"confirmDefault":false},{"name":"get_audit_log","category":"audit","readOnly":true,"confirmDefault":false}];
